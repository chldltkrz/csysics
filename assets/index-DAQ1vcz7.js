...
`,v=(t,s)=>{const e=document.createElement("div");e.className="lang-switcher",e.style.cssText=`
    position: fixed;
    top: 2rem;
    right: 2rem;
    z-index: 1000;
  ...
  `,new p("hero");const e=v(c,o=>{c=o,d()});s.appendChild(e)};d();
